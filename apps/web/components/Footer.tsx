...
export default function Footer() {
  return (
    <footer className="w-full bg-black text-white mt-20 border-t border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
            ...
            <div className="space-y-6">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed max-w-xs">
                ...
                world's top clubs and national teams.
              </p>
        ...
        <div className="border-t border-white/10 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-neutral-500 text-sm">
              © {new Date().getFullYear()} Crest Sports. All rights reserved.
            </p>
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <li>
      <Link
        href={href}
        className="text-neutral-400 hover:text-white transition-colors text-sm block w-fit"
      >
        {children}
      </Link>
    </li>
...
function SocialLink({
  ...
  return (
    <a
      href={href}
      aria-label={label}
      className="w-10 h-10 bg-white/5 hover:bg-white/10 rounded-full flex items-center justify-center transition-colors text-white/80 hover:text-white"
    >
