...
export default function Home() {
  return (
    <>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 py-16 md:py-24 grid md:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
            ...
            <div className="relative w-full max-w-md ml-auto">
              ...
              <div className="relative rounded-[22px] border border-white/70 bg-white/85 backdrop-blur-xl shadow-2xl p-6 md:p-7 flex flex-col gap-4 overflow-hidden">
                <div
                  className="absolute inset-0 hero-animated-glow"
                  aria-hidden
                />
                ...
                <div className="relative rounded-2xl overflow-hidden aspect-[4/5] bg-neutral-900 shadow-lg">
                  <img
                    src="/product-main-image.png"
                    alt="Featured jersey"
                    className="h-full w-full object-cover hero-float"
                  />
                  <div className="absolute inset-0 bg-gradient-to-b from-white/6 via-transparent to-black/15 mix-blend-soft-light" />
                </div>
      ...
      <style jsx global>{`
        .hero-animated-glow {
          background: conic-gradient(from 45deg, #0f0f0f, #3b3b3b, #0f0f0f);
          filter: blur(34px);
          opacity: 0.25;
